...
%  In this step, you will implement the convolution and test it on a small 
%  part of the data set to ensure that you have implemented this step correctly.
...
%  To ensure that you have implemented pooling correctly, we will use your 
%  pooling function to pool over a test matrix and check the results.
